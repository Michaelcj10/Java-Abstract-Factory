...
public class Gardener extends Frame
    ...
    //-----------------------------
    private class VeggieListener implements ItemListener {
    ...
    //-----------------------------
    private class PerenListener implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
    ...
    //-----------------------------
    private class AnnualListener implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
    ...
    private class TreeListener implements ItemListener {
        public void itemStateChanged(ItemEvent e) {
